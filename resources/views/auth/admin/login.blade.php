...
<head>
    ...
    <title>Admin Login - AdminHub</title>
    <!-- Google Fonts -->
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4">
                    ...
                    <div class="card-body p-4 p-lg-5">
                        <div class="text-center mb-4">
                            <a href="#" class="brand d-flex align-items-center justify-content-center mb-3">
                                ...
                                <span class="fs-4 fw-bold text-dark">TenderWiz Admin</span>
                            </a>
                        ...
                        @endif
                        <form action="{{ route('admin.check') }}" method="POST" id="loginForm">
                            @csrf
                ...
                <p class="text-center mt-3 text-muted small">&copy; {{ date('Y') }} AdminHub. All rights reserved.</p>
            </div>
        </div>
    </div>
